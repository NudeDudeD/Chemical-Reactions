Shader"Shader Graphs/SV Box Shader"
{
    Properties
    {
        _Hue("Hue", Float) = 1
...
SurfaceDescription SurfaceDescriptionFunction(SurfaceDescriptionInputs IN)
{
    ...
    Gradient _Gradient_e01f64b7043141018b63664de3cad0e0_Out_0_Gradient = NewGradient(0, 2, 2, float4(1, 1, 1, 0), float4(1, 0, 0, 1), float4(0, 0, 0, 0), float4(0, 0, 0, 0), float4(0, 0, 0, 0), float4(0, 0, 0, 0), float4(0, 0, 0, 0), float4(0, 0, 0, 0), float2(1, 0), float2(1, 1), float2(0, 0), float2(0, 0), float2(0, 0), float2(0, 0), float2(0, 0), float2(0, 0));
    ...
    Gradient _Gradient_b03325413f7847f3ab79d4fe529aaf31_Out_0_Gradient = NewGradient(0, 2, 2, float4(0, 0, 0, 0), float4(1, 1, 1, 1), float4(0, 0, 0, 0), float4(0, 0, 0, 0), float4(0, 0, 0, 0), float4(0, 0, 0, 0), float4(0, 0, 0, 0), float4(0, 0, 0, 0), float2(1, 0), float2(1, 1), float2(0, 0), float2(0, 0), float2(0, 0), float2(0, 0), float2(0, 0), float2(0, 0));
    float4 _SampleGradient_514ac51c68944bf88edcc6c8ac3463f5_Out_2_Vector4;
    Unity_SampleGradientV1_float(_Gradient_b03325413f7847f3ab79d4fe529aaf31_Out_0_Gradient, _Split_adb72921c89646a49e8b9b4b091659bd_G_2_Float, _SampleGradient_514ac51c68944bf88edcc6c8ac3463f5_Out_2_Vector4);
    float4 _Multiply_5ca8fd3618684c59a1d8fb1172c9edd1_Out_2_Vector4;
    Unity_Multiply_float4_float4(_SampleGradient_fc0c5e8ea73a48729e56243a5354f213_Out_2_Vector4, _SampleGradient_514ac51c68944bf88edcc6c8ac3463f5_Out_2_Vector4, _Multiply_5ca8fd3618684c59a1d8fb1172c9edd1_Out_2_Vector4);
    float3 _ColorspaceConversion_2762aa241a5f4ec8bd96cfc45990c438_Out_1_Vector3;
    Unity_ColorspaceConversion_RGB_HSV_float((_Multiply_5ca8fd3618684c59a1d8fb1172c9edd1_Out_2_Vector4.xyz), _ColorspaceConversion_2762aa241a5f4ec8bd96cfc45990c438_Out_1_Vector3);
    ...
    Unity_Combine_float(_Property_cf04fe43e40449b9ac9a716105f59449_Out_0_Float, _Split_073ff2d5c714471480ac30e066a180ff_G_2_Float, _Split_073ff2d5c714471480ac30e066a180ff_B_3_Float, 0, _Combine_8e2d2fbe932147f5a303d66dbf0d214e_RGBA_4_Vector4, _Combine_8e2d2fbe932147f5a303d66dbf0d214e_RGB_5_Vector3, _Combine_8e2d2fbe932147f5a303d66dbf0d214e_RG_6_Vector2);
